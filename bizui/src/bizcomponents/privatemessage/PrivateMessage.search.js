...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{privateMessageListAsSender:selectedRows}} owner={owner}  
	...
	data={{privateMessageListAsReceiver:selectedRows}} owner={owner}  
	...
	data={{privateMessageList:selectedRows}} owner={owner}  
  ...
  render(){
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        ...
        {showDeletionDialog(this,PrivateMessageModalTable,"privateMessageIds")}
