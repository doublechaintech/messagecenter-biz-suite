...
<Description term="Sender">{privateMessage.sender==null?appLocaleName(userContext,"NotAssigned"):privateMessage.sender.displayName}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"Sender","profile","requestCandidateSender",
	      "transferToAnotherSender","anotherSenderId",privateMessage.sender?privateMessage.sender.id:"")} 
...
<Description term="Receiver">{privateMessage.receiver==null?appLocaleName(userContext,"NotAssigned"):privateMessage.receiver.displayName}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"Receiver","profile","requestCandidateReceiver",
	      "transferToAnotherReceiver","anotherReceiverId",privateMessage.receiver?privateMessage.receiver.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
...
class PrivateMessagePreference extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"Private Message",cardsFor: "privateMessage",cardsSource: this.props.privateMessage,
  		subItems: [
