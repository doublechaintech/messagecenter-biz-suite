...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.PrivateMessageBase.renderItemOfList(item, targetComponents)

}



class PrivateMessageProfile extends Component {
...
}))(Form.create()(PrivateMessageProfile))
