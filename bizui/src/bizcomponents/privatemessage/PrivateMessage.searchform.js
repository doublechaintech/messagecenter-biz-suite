...
componentDidMount() {
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'content'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'sender'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'receiver'))
      ...
      dispatch({
        ...
        privateMessageSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"sender"} 
                    requestFunction={PrivateMessageService.requestCandidateSender}/>
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"receiver"} 
                    requestFunction={PrivateMessageService.requestCandidateReceiver}/>
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={PrivateMessageService.requestCandidatePlatform}/>
