...
const menuData = {menuName:"Private Message", menuFor: "privateMessage",
  		subItems: [
...
const displayColumns = [
  ...
  { title: 'Title', debugtype: 'string', dataIndex: 'title', width: '18',render: (text, record)=>renderTextCell(text,record) },
  { title: 'Content', debugtype: 'string_longtext', dataIndex: 'content', width: '10',render: (text, record)=>renderTextCell(text,record) },
  { title: 'Send Time', dataIndex: 'sendTime', render: (text, record) =>renderDateTimeCell(text,record)  },
  { title: 'Read Time', dataIndex: 'readTime', render: (text, record) =>renderDateTimeCell(text,record)  },
...
const PrivateMessageBase={menuData,displayColumns,fieldLabels}
