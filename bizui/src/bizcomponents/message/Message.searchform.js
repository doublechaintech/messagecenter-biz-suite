...
class MessageSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      messageList: 1,
      'messageList.searchField': fieldName,
      'messageList.searchVerb': 'startsWith',
      'messageList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`messageList.searchField`] = fieldName
    value[`messageList.searchVerb`] =  searchVerb
    value[`messageList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['messageList.orderBy.0'] = "id"
      params['messageList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        messageSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(MessageSearchForm)
