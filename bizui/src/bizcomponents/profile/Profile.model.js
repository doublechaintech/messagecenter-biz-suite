...
export default {
  ...
  effects: {
    ...
    *addPrivateMessageAsSender({ payload }, { call, put }) {
      const userContext = null
      const {ProfileService} = GlobalComponents;

      const { id, role, parameters, continueNext } = payload
      console.log('get form parameters', parameters)
      const data = yield call(ProfileService.addPrivateMessageAsSender, id, parameters)
      if (hasError(data)) {
    ...
    *updatePrivateMessageAsSender({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(ProfileService.updatePrivateMessageAsSender, id, parameters)
      if (hasError(data)) {
        handleServerError(data)
        return
      }
    ...
    *removePrivateMessageListAsSender({ payload }, { call, put }) {
     const userContext = null
      const {ProfileService} = GlobalComponents; 
      const { id, role, parameters, continueNext } = payload
      console.log('get form parameters', parameters)
      const data = yield call(ProfileService.removePrivateMessageListAsSender, id, parameters)
      if (hasError(data)) {
        handleServerError(data)
        return
      }
    ...
    *addPrivateMessageAsReceiver({ payload }, { call, put }) {
      const userContext = null
      const {ProfileService} = GlobalComponents;

      const { id, role, parameters, continueNext } = payload
      console.log('get form parameters', parameters)
      const data = yield call(ProfileService.addPrivateMessageAsReceiver, id, parameters)
      if (hasError(data)) {
        handleServerError(data)
        return
      }
    ...
    *updatePrivateMessageAsReceiver({ payload }, { call, put }) {
      ...
      const { id, type, parameters, continueNext, selectedRows, currentUpdateIndex } = payload
      console.log('get form parameters', parameters)
      const data = yield call(ProfileService.updatePrivateMessageAsReceiver, id, parameters)
      if (hasError(data)) {
        handleServerError(data)
        return
      }
    ...
    *removePrivateMessageListAsReceiver({ payload }, { call, put }) {
     const userContext = null
      const {ProfileService} = GlobalComponents; 
      const { id, role, parameters, continueNext } = payload
      console.log('get form parameters', parameters)
      const data = yield call(ProfileService.removePrivateMessageListAsReceiver, id, parameters)
      if (hasError(data)) {
        handleServerError(data)
        return
      }
