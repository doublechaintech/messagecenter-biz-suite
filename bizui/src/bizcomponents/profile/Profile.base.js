...
const menuData = {menuName:"Profile", menuFor: "profile",
  		subItems: [
  {name: 'privateMessageListAsSender', displayName:'Private Message(Sender)', icon:'at',readPermission: false,createPermission: false,deletePermission: false,updatePermission: false,executionPermission: false},
  {name: 'privateMessageListAsReceiver', displayName:'Private Message(Receiver)', icon:'at',readPermission: false,createPermission: false,deletePermission: false,updatePermission: false,executionPermission: false},
