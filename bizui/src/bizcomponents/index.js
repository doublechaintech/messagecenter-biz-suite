...
import ProfilePermission from './profile/Profile.permission';
...
import PrivateMessageAssociateForm from './privatemessage/PrivateMessage.associateform';
import PrivateMessageTable from './privatemessage/PrivateMessage.table';
import PrivateMessagePermission from './privatemessage/PrivateMessage.permission';
import PrivateMessageProfile from './privatemessage/PrivateMessage.profile';
...
const ViewMapping = {
  ...
  'com.doublechaintech.messagecenter.platform.Platform': {name:'platform'},
  'com.doublechaintech.messagecenter.profile.Profile': {name:'profile'},
  'com.doublechaintech.messagecenter.privatemessage.PrivateMessage': {name:'privateMessage'},
  'com.doublechaintech.messagecenter.userdomain.UserDomain': {name:'userDomain'},
  'com.doublechaintech.messagecenter.userwhitelist.UserWhiteList': {name:'userWhiteList'},
  'com.doublechaintech.messagecenter.secuser.SecUser': {name:'secUser'},
  'com.doublechaintech.messagecenter.secuserblocking.SecUserBlocking': {name:'secUserBlocking'},
  'com.doublechaintech.messagecenter.userapp.UserApp': {name:'userApp'},
  'com.doublechaintech.messagecenter.listaccess.ListAccess': {name:'listAccess'},
  'com.doublechaintech.messagecenter.objectaccess.ObjectAccess': {name:'objectAccess'},
  'com.doublechaintech.messagecenter.loginhistory.LoginHistory': {name:'loginHistory'},
...
const OOTBComponents={
    ...
    PrivateMessageAssociateForm,
    PrivateMessageTable,
    PrivateMessagePermission,
    PrivateMessageProfile,
