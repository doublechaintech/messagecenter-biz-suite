<%@ page import='java.util.*,com.doublechaintech.messagecenter.*,com.doublechaintech.messagecenter.formfield.FormField'%>
...
<sky:include page="com/doublechaintech/messagecenter/formfield/FormField$Summary.jsp" />
