<%@ page import='java.util.*,com.doublechaintech.messagecenter.*,com.doublechaintech.messagecenter.loginhistory.LoginHistory'%>
...
<sky:include page="com/doublechaintech/messagecenter/loginhistory/LoginHistory$Summary.jsp" />
