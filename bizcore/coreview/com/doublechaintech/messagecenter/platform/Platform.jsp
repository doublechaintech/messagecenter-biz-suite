<%@ page import='java.util.*,com.doublechaintech.messagecenter.*,com.doublechaintech.messagecenter.platform.Platform'%>
...
<div class="row">
	...
	<% Platform result = (Platform)request.getAttribute("result");  %>
			...
			<li><a data-toggle="tab" href="#privateMessageList" class="disabled"> ${userContext.localeMap['private_message']}</a></li>
...
<sky:include page="com/doublechaintech/messagecenter/platform/Platform$Summary.jsp" />
		...
		<div id="profileList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechaintech/messagecenter/profile/Profile$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["privateMessageList"] or ignoreListAccessControl}'>
		<c:set var="privateMessageList" value="${result.privateMessageList}" scope="request"/>
		<c:set var="privateMessageListName" value="privateMessageList" scope="request"/>
		<div id="privateMessageList" class="tab-pane fade sublist" refer-name="platform">
