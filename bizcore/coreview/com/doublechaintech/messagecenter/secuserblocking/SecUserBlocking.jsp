<%@ page import='java.util.*,com.doublechaintech.messagecenter.*,com.doublechaintech.messagecenter.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/doublechaintech/messagecenter/secuserblocking/SecUserBlocking$Summary.jsp" />
