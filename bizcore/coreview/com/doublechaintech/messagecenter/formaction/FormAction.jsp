<%@ page import='java.util.*,com.doublechaintech.messagecenter.*,com.doublechaintech.messagecenter.formaction.FormAction'%>
...
<sky:include page="com/doublechaintech/messagecenter/formaction/FormAction$Summary.jsp" />
