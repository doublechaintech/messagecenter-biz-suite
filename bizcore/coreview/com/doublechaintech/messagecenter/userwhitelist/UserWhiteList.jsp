<%@ page import='java.util.*,com.doublechaintech.messagecenter.*,com.doublechaintech.messagecenter.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/doublechaintech/messagecenter/userwhitelist/UserWhiteList$Summary.jsp" />
