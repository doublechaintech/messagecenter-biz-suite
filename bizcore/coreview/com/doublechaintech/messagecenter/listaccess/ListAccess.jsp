<%@ page import='java.util.*,com.doublechaintech.messagecenter.*,com.doublechaintech.messagecenter.listaccess.ListAccess'%>
...
<sky:include page="com/doublechaintech/messagecenter/listaccess/ListAccess$Summary.jsp" />
