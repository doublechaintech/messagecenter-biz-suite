<%@ page import='java.util.*,com.doublechaintech.messagecenter.*,com.doublechaintech.messagecenter.privatemessage.PrivateMessage'%>
...
<c:set var="ownerBeanName" value="privateMessage" scope="request"/>
<c:set var="ownerClassName" value="PrivateMessage" scope="request"/>
...
<div class="row">
	...
	<% PrivateMessage result = (PrivateMessage)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="privateMessage" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/messagecenter/privatemessage/PrivateMessage$Summary.jsp" />
