<%@ page import='java.util.*,com.doublechaintech.messagecenter.*,com.doublechaintech.messagecenter.secuser.SecUser'%>
...
<sky:include page="com/doublechaintech/messagecenter/secuser/SecUser$Summary.jsp" />
...
<sky:include page="com/doublechaintech/messagecenter/userdomain/UserDomain$Info.jsp" />
...
<sky:include page="com/doublechaintech/messagecenter/secuserblocking/SecUserBlocking$Action.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/messagecenter/userapp/UserApp$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["loginHistoryList"] or ignoreListAccessControl}'>
		...
		<div id="loginHistoryList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/messagecenter/loginhistory/LoginHistory$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
