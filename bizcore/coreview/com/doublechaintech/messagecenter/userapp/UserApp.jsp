<%@ page import='java.util.*,com.doublechaintech.messagecenter.*,com.doublechaintech.messagecenter.userapp.UserApp'%>
...
<sky:include page="com/doublechaintech/messagecenter/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/doublechaintech/messagecenter/secuser/SecUser$Info.jsp" />
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/messagecenter/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/messagecenter/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
