<%@ page import='java.util.*,com.doublechaintech.messagecenter.*,com.doublechaintech.messagecenter.formmessage.FormMessage'%>
...
<sky:include page="com/doublechaintech/messagecenter/formmessage/FormMessage$Summary.jsp" />
