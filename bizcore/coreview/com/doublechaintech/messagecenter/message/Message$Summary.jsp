...
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['message.send_time']}</span>
<span ><fmt:formatDate pattern="yyyy-MM-dd" value="${result.sendTime}" /></span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['message.read_time']}</span>
<span ><fmt:formatDate pattern="yyyy-MM-dd" value="${result.readTime}" /></span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['message.status']}</span>
