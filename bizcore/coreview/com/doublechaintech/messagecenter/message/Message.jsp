<%@ page import='java.util.*,com.doublechaintech.messagecenter.*,com.doublechaintech.messagecenter.message.Message'%>
...
<div class="row">
	...
	<% Message result = (Message)request.getAttribute("result");  %>
...
<sky:include page="com/doublechaintech/messagecenter/message/Message$Summary.jsp" />
