...
import com.doublechaintech.messagecenter.userapp.CandidateUserApp;
...
public class ObjectAccessManagerImpl extends CustomMessagecenterCheckerManager implements ObjectAccessManager {
	...
	protected void throwExceptionWithMessage(String value) throws ObjectAccessManagerException{
 	...
 	protected ObjectAccess saveObjectAccess(MessagecenterUserContext userContext, ObjectAccess objectAccess, String [] tokensExpr) throws Exception{	
 	...
 	protected ObjectAccess saveObjectAccessDetail(MessagecenterUserContext userContext, ObjectAccess objectAccess) throws Exception{	

 		
 		return saveObjectAccess(userContext, objectAccess, allTokens());
 	}
 	
 	public ObjectAccess loadObjectAccess(MessagecenterUserContext userContext, String objectAccessId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ObjectAccess searchObjectAccess(MessagecenterUserContext userContext, String objectAccessId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ObjectAccess present(MessagecenterUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens) throws Exception {
 	...
 	public ObjectAccess loadObjectAccessDetail(MessagecenterUserContext userContext, String objectAccessId) throws Exception{	
 	...
 	public Object view(MessagecenterUserContext userContext, String objectAccessId) throws Exception{	
 		ObjectAccess objectAccess = loadObjectAccess( userContext, objectAccessId, viewTokens());
 		return present(userContext,objectAccess, allTokens());
		
 	}
 	protected ObjectAccess saveObjectAccess(MessagecenterUserContext userContext, ObjectAccess objectAccess, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getObjectAccessDAO().save(objectAccess, tokens);
 	}
 	protected ObjectAccess loadObjectAccess(MessagecenterUserContext userContext, String objectAccessId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfObjectAccess(objectAccessId);
		userContext.getChecker().throwExceptionIfHasErrors( ObjectAccessManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens){
	...
	public ObjectAccess createObjectAccess(MessagecenterUserContext userContext,String name, String objectType, String list1, String list2, String list3, String list4, String list5, String list6, String list7, String list8, String list9, String appId) throws Exception
	{
	...
	protected void checkParamsForUpdatingObjectAccess(MessagecenterUserContext userContext,String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ObjectAccess clone(MessagecenterUserContext userContext, String fromObjectAccessId) throws Exception{
		
		return userContext.getDAOGroup().getObjectAccessDAO().clone(fromObjectAccessId, this.allTokens());
	}
	
	public ObjectAccess internalSaveObjectAccess(MessagecenterUserContext userContext, ObjectAccess objectAccess) throws Exception 
	{
		return internalSaveObjectAccess(userContext, objectAccess, allTokens());

	}
	public ObjectAccess internalSaveObjectAccess(MessagecenterUserContext userContext, ObjectAccess objectAccess, Map<String,Object> options) throws Exception 
	{
	...
	public ObjectAccess updateObjectAccess(MessagecenterUserContext userContext,String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingObjectAccess(userContext, objectAccessId, objectAccessVersion, property, newValueExpr, tokensExpr);
	...
	public ObjectAccess updateObjectAccessProperty(MessagecenterUserContext userContext,String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingObjectAccess(userContext, objectAccessId, objectAccessVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherApp(MessagecenterUserContext userContext, String objectAccessId, String anotherAppId) throws Exception
 	{
 	...
 	public ObjectAccess transferToAnotherApp(MessagecenterUserContext userContext, String objectAccessId, String anotherAppId) throws Exception
 	{
	...
	public CandidateUserApp requestCandidateApp(MessagecenterUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected UserApp loadUserApp(MessagecenterUserContext userContext, String newAppId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(MessagecenterUserContext userContext, String objectAccessId, int objectAccessVersion) throws Exception {
	...
	public ObjectAccess forgetByAll(MessagecenterUserContext userContext, String objectAccessId, int objectAccessVersion) throws Exception {
		return forgetByAllInternal(userContext, objectAccessId, objectAccessVersion);		
	}
	protected ObjectAccess forgetByAllInternal(MessagecenterUserContext userContext,
			String objectAccessId, int objectAccessVersion) throws Exception{
	...
	public void onNewInstanceCreated(MessagecenterUserContext userContext, ObjectAccess newCreated) throws Exception{
