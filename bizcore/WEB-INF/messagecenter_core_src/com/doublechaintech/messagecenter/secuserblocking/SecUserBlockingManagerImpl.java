...
public class SecUserBlockingManagerImpl extends CustomMessagecenterCheckerManager implements SecUserBlockingManager {
	...
	protected void throwExceptionWithMessage(String value) throws SecUserBlockingManagerException{
 	...
 	protected SecUserBlocking saveSecUserBlocking(MessagecenterUserContext userContext, SecUserBlocking secUserBlocking, String [] tokensExpr) throws Exception{	
 	...
 	protected SecUserBlocking saveSecUserBlockingDetail(MessagecenterUserContext userContext, SecUserBlocking secUserBlocking) throws Exception{	
 	...
 	public SecUserBlocking loadSecUserBlocking(MessagecenterUserContext userContext, String secUserBlockingId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SecUserBlocking searchSecUserBlocking(MessagecenterUserContext userContext, String secUserBlockingId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SecUserBlocking present(MessagecenterUserContext userContext, SecUserBlocking secUserBlocking, Map<String, Object> tokens) throws Exception {
 	...
 	public SecUserBlocking loadSecUserBlockingDetail(MessagecenterUserContext userContext, String secUserBlockingId) throws Exception{	
 	...
 	public Object view(MessagecenterUserContext userContext, String secUserBlockingId) throws Exception{	
 		SecUserBlocking secUserBlocking = loadSecUserBlocking( userContext, secUserBlockingId, viewTokens());
 		return present(userContext,secUserBlocking, allTokens());
		
 	}
 	protected SecUserBlocking saveSecUserBlocking(MessagecenterUserContext userContext, SecUserBlocking secUserBlocking, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getSecUserBlockingDAO().save(secUserBlocking, tokens);
 	}
 	protected SecUserBlocking loadSecUserBlocking(MessagecenterUserContext userContext, String secUserBlockingId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfSecUserBlocking(secUserBlockingId);
		userContext.getChecker().throwExceptionIfHasErrors( SecUserBlockingManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, SecUserBlocking secUserBlocking, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, SecUserBlocking secUserBlocking, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSecUserBlocking(MessagecenterUserContext userContext,String secUserBlockingId, int secUserBlockingVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SecUserBlocking clone(MessagecenterUserContext userContext, String fromSecUserBlockingId) throws Exception{
	...
	public SecUserBlocking internalSaveSecUserBlocking(MessagecenterUserContext userContext, SecUserBlocking secUserBlocking, Map<String,Object> options) throws Exception 
	{
	...
	public SecUserBlocking updateSecUserBlockingProperty(MessagecenterUserContext userContext,String secUserBlockingId, int secUserBlockingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingSecUserBlocking(userContext, secUserBlockingId, secUserBlockingVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(MessagecenterUserContext userContext, String secUserBlockingId, int secUserBlockingVersion) throws Exception {
	...
	public SecUserBlocking forgetByAll(MessagecenterUserContext userContext, String secUserBlockingId, int secUserBlockingVersion) throws Exception {
		return forgetByAllInternal(userContext, secUserBlockingId, secUserBlockingVersion);		
	}
	protected SecUserBlocking forgetByAllInternal(MessagecenterUserContext userContext,
			String secUserBlockingId, int secUserBlockingVersion) throws Exception{
	...
	protected SecUserBlocking breakWithSecUserByDomain(MessagecenterUserContext userContext, String secUserBlockingId, String domainId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingSecUser(MessagecenterUserContext userContext, String secUserBlockingId, String login, String mobile, String email, String pwd, String weixinOpenid, String weixinAppid, String accessToken, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime, String domainId,String [] tokensExpr) throws Exception{
	...
	public  SecUserBlocking addSecUser(MessagecenterUserContext userContext, String secUserBlockingId, String login, String mobile, String email, String pwd, String weixinOpenid, String weixinAppid, String accessToken, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime, String domainId, String [] tokensExpr) throws Exception
	{	
	...
	protected void checkParamsForUpdatingSecUserProperties(MessagecenterUserContext userContext, String secUserBlockingId,String id,String login,String mobile,String email,String pwd,String weixinOpenid,String weixinAppid,String accessToken,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime,String [] tokensExpr) throws Exception {
	...
	public  SecUserBlocking updateSecUserProperties(MessagecenterUserContext userContext, String secUserBlockingId, String id,String login,String mobile,String email,String pwd,String weixinOpenid,String weixinAppid,String accessToken,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime, String [] tokensExpr) throws Exception
	{	
	...
	protected SecUser createSecUser(MessagecenterUserContext userContext, String login, String mobile, String email, String pwd, String weixinOpenid, String weixinAppid, String accessToken, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime, String domainId) throws Exception{
	...
	protected void checkParamsForRemovingSecUserList(MessagecenterUserContext userContext, String secUserBlockingId, 
	...
	public  SecUserBlocking removeSecUserList(MessagecenterUserContext userContext, String secUserBlockingId, 
			String secUserIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSecUser(MessagecenterUserContext userContext, String secUserBlockingId, 
	...
	public  SecUserBlocking removeSecUser(MessagecenterUserContext userContext, String secUserBlockingId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSecUser(MessagecenterUserContext userContext, String secUserBlockingId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUserBlocking copySecUserFrom(MessagecenterUserContext userContext, String secUserBlockingId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUser(MessagecenterUserContext userContext, String secUserBlockingId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUserBlocking updateSecUser(MessagecenterUserContext userContext, String secUserBlockingId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
