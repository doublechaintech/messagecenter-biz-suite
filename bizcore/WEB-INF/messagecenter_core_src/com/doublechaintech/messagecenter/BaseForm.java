...
public class BaseForm extends GenericForm{
	...
	protected FormField idFromPrivateMessage(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Id");
		field.setLocaleKey("private_message.id");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField titleFromPrivateMessage(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Title");
		field.setLocaleKey("private_message.title");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField contentFromPrivateMessage(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Content");
		field.setLocaleKey("private_message.content");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
	...
	protected FormField sendTimeFromPrivateMessage(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Send Time");
		field.setLocaleKey("private_message.send_time");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("date_time");
		field.setRequired(true);
		field.setPlaceholder("请填写Send Time");
		return field;
	}

	protected FormField readTimeFromPrivateMessage(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Read Time");
		field.setLocaleKey("private_message.read_time");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("date_time");
		field.setRequired(true);
		field.setPlaceholder("请填写Read Time");
		return field;
	}

	protected FormField senderIdFromPrivateMessage(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Sender");
		field.setLocaleKey("private_message.sender");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("Profile");
		field.setRequired(true);
		field.setPlaceholder("请填写Sender");
		return field;
	}

	protected FormField receiverIdFromPrivateMessage(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Receiver");
		field.setLocaleKey("private_message.receiver");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("Profile");
		field.setRequired(true);
		field.setPlaceholder("请填写Receiver");
		return field;
	}

	protected FormField statusFromPrivateMessage(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Status");
		field.setLocaleKey("private_message.status");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField platformIdFromPrivateMessage(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Platform");
		field.setLocaleKey("private_message.platform");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("Platform");
