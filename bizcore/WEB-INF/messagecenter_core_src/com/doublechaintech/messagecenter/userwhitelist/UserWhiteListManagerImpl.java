...
public class UserWhiteListManagerImpl extends CustomMessagecenterCheckerManager implements UserWhiteListManager {
	...
	protected void throwExceptionWithMessage(String value) throws UserWhiteListManagerException{
 	...
 	protected UserWhiteList saveUserWhiteList(MessagecenterUserContext userContext, UserWhiteList userWhiteList, String [] tokensExpr) throws Exception{	
 	...
 	protected UserWhiteList saveUserWhiteListDetail(MessagecenterUserContext userContext, UserWhiteList userWhiteList) throws Exception{	
 	...
 	public UserWhiteList loadUserWhiteList(MessagecenterUserContext userContext, String userWhiteListId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserWhiteList searchUserWhiteList(MessagecenterUserContext userContext, String userWhiteListId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserWhiteList present(MessagecenterUserContext userContext, UserWhiteList userWhiteList, Map<String, Object> tokens) throws Exception {
 	...
 	public UserWhiteList loadUserWhiteListDetail(MessagecenterUserContext userContext, String userWhiteListId) throws Exception{	
 	...
 	public Object view(MessagecenterUserContext userContext, String userWhiteListId) throws Exception{	
 		UserWhiteList userWhiteList = loadUserWhiteList( userContext, userWhiteListId, viewTokens());
 		return present(userContext,userWhiteList, allTokens());
		
 	}
 	protected UserWhiteList saveUserWhiteList(MessagecenterUserContext userContext, UserWhiteList userWhiteList, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getUserWhiteListDAO().save(userWhiteList, tokens);
 	}
 	protected UserWhiteList loadUserWhiteList(MessagecenterUserContext userContext, String userWhiteListId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfUserWhiteList(userWhiteListId);
		userContext.getChecker().throwExceptionIfHasErrors( UserWhiteListManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, UserWhiteList userWhiteList, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, UserWhiteList userWhiteList, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserWhiteList(MessagecenterUserContext userContext,String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserWhiteList clone(MessagecenterUserContext userContext, String fromUserWhiteListId) throws Exception{
	...
	public UserWhiteList internalSaveUserWhiteList(MessagecenterUserContext userContext, UserWhiteList userWhiteList, Map<String,Object> options) throws Exception 
	{
	...
	public UserWhiteList updateUserWhiteListProperty(MessagecenterUserContext userContext,String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingUserWhiteList(userContext, userWhiteListId, userWhiteListVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherDomain(MessagecenterUserContext userContext, String userWhiteListId, String anotherDomainId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(MessagecenterUserContext userContext, String userWhiteListId, int userWhiteListVersion) throws Exception {
	...
	public UserWhiteList forgetByAll(MessagecenterUserContext userContext, String userWhiteListId, int userWhiteListVersion) throws Exception {
		return forgetByAllInternal(userContext, userWhiteListId, userWhiteListVersion);		
	}
	protected UserWhiteList forgetByAllInternal(MessagecenterUserContext userContext,
			String userWhiteListId, int userWhiteListVersion) throws Exception{
