...
public class FormFieldManagerImpl extends CustomMessagecenterCheckerManager implements FormFieldManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormFieldManagerException{
 	...
 	protected FormField saveFormField(MessagecenterUserContext userContext, FormField formField, String [] tokensExpr) throws Exception{	
 	...
 	protected FormField saveFormFieldDetail(MessagecenterUserContext userContext, FormField formField) throws Exception{	
 	...
 	public FormField loadFormField(MessagecenterUserContext userContext, String formFieldId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormField searchFormField(MessagecenterUserContext userContext, String formFieldId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormField present(MessagecenterUserContext userContext, FormField formField, Map<String, Object> tokens) throws Exception {
 	...
 	public FormField loadFormFieldDetail(MessagecenterUserContext userContext, String formFieldId) throws Exception{	
 		FormField formField = loadFormField( userContext, formFieldId, allTokens());
 		return present(userContext,formField, allTokens());
		
 	}
 	
 	public Object view(MessagecenterUserContext userContext, String formFieldId) throws Exception{	
 		FormField formField = loadFormField( userContext, formFieldId, viewTokens());
 		return present(userContext,formField, allTokens());
		
 	}
 	protected FormField saveFormField(MessagecenterUserContext userContext, FormField formField, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormFieldDAO().save(formField, tokens);
 	}
 	protected FormField loadFormField(MessagecenterUserContext userContext, String formFieldId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormField(formFieldId);
		userContext.getChecker().throwExceptionIfHasErrors( FormFieldManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, FormField formField, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, FormField formField, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormField(MessagecenterUserContext userContext,String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormField clone(MessagecenterUserContext userContext, String fromFormFieldId) throws Exception{
	...
	public FormField internalSaveFormField(MessagecenterUserContext userContext, FormField formField, Map<String,Object> options) throws Exception 
	{
	...
	public FormField updateFormFieldProperty(MessagecenterUserContext userContext,String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormField(userContext, formFieldId, formFieldVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(MessagecenterUserContext userContext, String formFieldId, String anotherFormId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(MessagecenterUserContext userContext, String formFieldId, int formFieldVersion) throws Exception {
	...
	public FormField forgetByAll(MessagecenterUserContext userContext, String formFieldId, int formFieldVersion) throws Exception {
		return forgetByAllInternal(userContext, formFieldId, formFieldVersion);		
	}
	protected FormField forgetByAllInternal(MessagecenterUserContext userContext,
			String formFieldId, int formFieldVersion) throws Exception{
