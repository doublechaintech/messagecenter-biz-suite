...
import com.doublechaintech.messagecenter.userdomain.CandidateUserDomain;
import com.doublechaintech.messagecenter.secuserblocking.CandidateSecUserBlocking;
...
public class SecUserManagerImpl extends CustomMessagecenterCheckerManager implements SecUserManager {
	...
	protected void throwExceptionWithMessage(String value) throws SecUserManagerException{
 	...
 	protected SecUser saveSecUser(MessagecenterUserContext userContext, SecUser secUser, String [] tokensExpr) throws Exception{	
 	...
 	protected SecUser saveSecUserDetail(MessagecenterUserContext userContext, SecUser secUser) throws Exception{	
 	...
 	public SecUser loadSecUser(MessagecenterUserContext userContext, String secUserId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SecUser searchSecUser(MessagecenterUserContext userContext, String secUserId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SecUser present(MessagecenterUserContext userContext, SecUser secUser, Map<String, Object> tokens) throws Exception {
 	...
 	public SecUser loadSecUserDetail(MessagecenterUserContext userContext, String secUserId) throws Exception{	
 		SecUser secUser = loadSecUser( userContext, secUserId, allTokens());
 		return present(userContext,secUser, allTokens());
		
 	}
 	
 	public Object view(MessagecenterUserContext userContext, String secUserId) throws Exception{	
 		SecUser secUser = loadSecUser( userContext, secUserId, viewTokens());
 		return present(userContext,secUser, allTokens());
		
 	}
 	protected SecUser saveSecUser(MessagecenterUserContext userContext, SecUser secUser, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getSecUserDAO().save(secUser, tokens);
 	}
 	protected SecUser loadSecUser(MessagecenterUserContext userContext, String secUserId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfSecUser(secUserId);
		userContext.getChecker().throwExceptionIfHasErrors( SecUserManagerException.class);
	...
	public SecUser loadSecUserWithMobile(MessagecenterUserContext userContext, String mobile, Map<String,Object>tokens) throws Exception{	
 	...
 	protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, SecUser secUser, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, SecUser secUser, Map<String, Object> tokens){
	...
	public SecUser createSecUser(MessagecenterUserContext userContext,String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime, String domainId) throws Exception
	{
	...
	protected void checkParamsForUpdatingSecUser(MessagecenterUserContext userContext,String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SecUser clone(MessagecenterUserContext userContext, String fromSecUserId) throws Exception{
	...
	public SecUser internalSaveSecUser(MessagecenterUserContext userContext, SecUser secUser, Map<String,Object> options) throws Exception 
	{
	...
	public SecUser updateSecUserProperty(MessagecenterUserContext userContext,String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingSecUser(userContext, secUserId, secUserVersion, property, newValueExpr, tokensExpr);
	...
	private static final String [] STATUS_SEQUENCE={"BLOCKED"};
 	protected String[] getNextCandidateStatus(MessagecenterUserContext userContext, String currentStatus) throws Exception{
 	...
 	protected void ensureStatus(MessagecenterUserContext userContext, SecUser secUser, String expectedNextStatus) throws Exception{
	...
	protected void checkParamsForTransferingAnotherDomain(MessagecenterUserContext userContext, String secUserId, String anotherDomainId) throws Exception
 	{
	...
	public CandidateUserDomain requestCandidateDomain(MessagecenterUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherBlocking(MessagecenterUserContext userContext, String secUserId, String anotherBlockingId) throws Exception
 	{
 	...
 	public SecUser transferToAnotherBlocking(MessagecenterUserContext userContext, String secUserId, String anotherBlockingId) throws Exception
 	{
	...
	public CandidateSecUserBlocking requestCandidateBlocking(MessagecenterUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
	...
	public static final String BLOCKED_STATUS = "BLOCKED";
 	protected void checkParamsForBlocking(MessagecenterUserContext userContext, String secUserId, String who, String comments
) throws Exception
 	{
 				userContext.getChecker().checkIdOfSecUser(secUserId);
 	...
 	public SecUserForm blockActionForm(MessagecenterUserContext userContext, String secUserId) throws Exception
 	{
 	...
 	protected SecUserBlocking createBlocking(MessagecenterUserContext userContext, String who, String comments){
 	...
 	protected void checkIfEligibleForBlocking(MessagecenterUserContext userContext, SecUser secUser) throws Exception{
...
//--------------------------------------------------------------
 	...
 	protected SecUserBlocking loadSecUserBlocking(MessagecenterUserContext userContext, String newBlockingId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected UserDomain loadUserDomain(MessagecenterUserContext userContext, String newDomainId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(MessagecenterUserContext userContext, String secUserId, int secUserVersion) throws Exception {
	...
	public SecUser forgetByAll(MessagecenterUserContext userContext, String secUserId, int secUserVersion) throws Exception {
		return forgetByAllInternal(userContext, secUserId, secUserVersion);		
	}
	protected SecUser forgetByAllInternal(MessagecenterUserContext userContext,
			String secUserId, int secUserVersion) throws Exception{
	...
	protected SecUser breakWithUserAppByObjectId(MessagecenterUserContext userContext, String secUserId, String objectIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingUserApp(MessagecenterUserContext userContext, String secUserId, String title, String appIcon, boolean fullAccess, String permission, String objectType, String objectId, String location,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserAppProperties(MessagecenterUserContext userContext, String secUserId,String id,String title,String appIcon,boolean fullAccess,String permission,String objectType,String objectId,String location,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateUserAppProperties(MessagecenterUserContext userContext, String secUserId, String id,String title,String appIcon,boolean fullAccess,String permission,String objectType,String objectId,String location, String [] tokensExpr) throws Exception
	{	
	...
	protected UserApp createUserApp(MessagecenterUserContext userContext, String title, String appIcon, boolean fullAccess, String permission, String objectType, String objectId, String location) throws Exception{
	...
	protected void checkParamsForRemovingUserAppList(MessagecenterUserContext userContext, String secUserId, 
	...
	public  SecUser removeUserAppList(MessagecenterUserContext userContext, String secUserId, 
			String userAppIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingUserApp(MessagecenterUserContext userContext, String secUserId, 
	...
	public  SecUser removeUserApp(MessagecenterUserContext userContext, String secUserId, 
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingUserApp(MessagecenterUserContext userContext, String secUserId, 
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyUserAppFrom(MessagecenterUserContext userContext, String secUserId, 
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserApp(MessagecenterUserContext userContext, String secUserId, String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateUserApp(MessagecenterUserContext userContext, String secUserId, String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingLoginHistory(MessagecenterUserContext userContext, String secUserId, String fromIp, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLoginHistoryProperties(MessagecenterUserContext userContext, String secUserId,String id,String fromIp,String description,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateLoginHistoryProperties(MessagecenterUserContext userContext, String secUserId, String id,String fromIp,String description, String [] tokensExpr) throws Exception
	{	
	...
	protected LoginHistory createLoginHistory(MessagecenterUserContext userContext, String fromIp, String description) throws Exception{
	...
	protected void checkParamsForRemovingLoginHistoryList(MessagecenterUserContext userContext, String secUserId, 
	...
	public  SecUser removeLoginHistoryList(MessagecenterUserContext userContext, String secUserId, 
			String loginHistoryIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingLoginHistory(MessagecenterUserContext userContext, String secUserId, 
	...
	public  SecUser removeLoginHistory(MessagecenterUserContext userContext, String secUserId, 
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingLoginHistory(MessagecenterUserContext userContext, String secUserId, 
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyLoginHistoryFrom(MessagecenterUserContext userContext, String secUserId, 
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLoginHistory(MessagecenterUserContext userContext, String secUserId, String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateLoginHistory(MessagecenterUserContext userContext, String secUserId, String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
