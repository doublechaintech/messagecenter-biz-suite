...
public class SecUserJDBCTemplateDAO extends MessagecenterNamingServiceDAO implements SecUserDAO{
	...
	*/
    ...
    public SmartList<SecUser> requestCandidateSecUserForUserApp(MessagecenterUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<SecUser> requestCandidateSecUserForLoginHistory(MessagecenterUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(SecUserTable.COLUMN_LOGIN, filterKey, pageNo, pageSize, getSecUserMapper());
    }
	...
	public SmartList<UserApp> loadOurUserAppList(MessagecenterUserContext userContext, List<SecUser> us, Map<String,Object> options) throws Exception{
	...
	public SmartList<LoginHistory> loadOurLoginHistoryList(MessagecenterUserContext userContext, List<SecUser> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return new SmartList<>();
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
