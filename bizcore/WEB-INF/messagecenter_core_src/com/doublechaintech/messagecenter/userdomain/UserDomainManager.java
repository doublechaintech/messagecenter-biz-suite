...
public interface UserDomainManager{
	...
	*/
	...
	//public  SecUserManager getSecUserManager(MessagecenterUserContext userContext, String userDomainId, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime ,String [] tokensExpr)  throws Exception;
