...
public class UserDomainManagerImpl extends CustomMessagecenterCheckerManager implements UserDomainManager {
	...
	protected void throwExceptionWithMessage(String value) throws UserDomainManagerException{
 	...
 	protected UserDomain saveUserDomain(MessagecenterUserContext userContext, UserDomain userDomain, String [] tokensExpr) throws Exception{	
 	...
 	protected UserDomain saveUserDomainDetail(MessagecenterUserContext userContext, UserDomain userDomain) throws Exception{	
 	...
 	public UserDomain loadUserDomain(MessagecenterUserContext userContext, String userDomainId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserDomain searchUserDomain(MessagecenterUserContext userContext, String userDomainId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserDomain present(MessagecenterUserContext userContext, UserDomain userDomain, Map<String, Object> tokens) throws Exception {
 	...
 	public UserDomain loadUserDomainDetail(MessagecenterUserContext userContext, String userDomainId) throws Exception{	
 		UserDomain userDomain = loadUserDomain( userContext, userDomainId, allTokens());
 		return present(userContext,userDomain, allTokens());
		
 	}
 	
 	public Object view(MessagecenterUserContext userContext, String userDomainId) throws Exception{	
 		UserDomain userDomain = loadUserDomain( userContext, userDomainId, viewTokens());
 		return present(userContext,userDomain, allTokens());
		
 	}
 	protected UserDomain saveUserDomain(MessagecenterUserContext userContext, UserDomain userDomain, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getUserDomainDAO().save(userDomain, tokens);
 	}
 	protected UserDomain loadUserDomain(MessagecenterUserContext userContext, String userDomainId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfUserDomain(userDomainId);
		userContext.getChecker().throwExceptionIfHasErrors( UserDomainManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, UserDomain userDomain, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, UserDomain userDomain, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserDomain(MessagecenterUserContext userContext,String userDomainId, int userDomainVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserDomain clone(MessagecenterUserContext userContext, String fromUserDomainId) throws Exception{
	...
	public UserDomain internalSaveUserDomain(MessagecenterUserContext userContext, UserDomain userDomain, Map<String,Object> options) throws Exception 
	{
	...
	public UserDomain updateUserDomainProperty(MessagecenterUserContext userContext,String userDomainId, int userDomainVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingUserDomain(userContext, userDomainId, userDomainVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(MessagecenterUserContext userContext, String userDomainId, int userDomainVersion) throws Exception {
	...
	public UserDomain forgetByAll(MessagecenterUserContext userContext, String userDomainId, int userDomainVersion) throws Exception {
		return forgetByAllInternal(userContext, userDomainId, userDomainVersion);		
	}
	protected UserDomain forgetByAllInternal(MessagecenterUserContext userContext,
			String userDomainId, int userDomainVersion) throws Exception{
	...
	protected void checkParamsForAddingUserWhiteList(MessagecenterUserContext userContext, String userDomainId, String userIdentity, String userSpecialFunctions,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserWhiteListProperties(MessagecenterUserContext userContext, String userDomainId,String id,String userIdentity,String userSpecialFunctions,String [] tokensExpr) throws Exception {
	...
	public  UserDomain updateUserWhiteListProperties(MessagecenterUserContext userContext, String userDomainId, String id,String userIdentity,String userSpecialFunctions, String [] tokensExpr) throws Exception
	{	
	...
	protected UserWhiteList createUserWhiteList(MessagecenterUserContext userContext, String userIdentity, String userSpecialFunctions) throws Exception{
	...
	protected void checkParamsForRemovingUserWhiteListList(MessagecenterUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeUserWhiteListList(MessagecenterUserContext userContext, String userDomainId, 
			String userWhiteListIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingUserWhiteList(MessagecenterUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeUserWhiteList(MessagecenterUserContext userContext, String userDomainId, 
		String userWhiteListId, int userWhiteListVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingUserWhiteList(MessagecenterUserContext userContext, String userDomainId, 
		String userWhiteListId, int userWhiteListVersion,String [] tokensExpr) throws Exception{
	...
	public  UserDomain copyUserWhiteListFrom(MessagecenterUserContext userContext, String userDomainId, 
		String userWhiteListId, int userWhiteListVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserWhiteList(MessagecenterUserContext userContext, String userDomainId, String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserDomain updateUserWhiteList(MessagecenterUserContext userContext, String userDomainId, String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingSecUser(MessagecenterUserContext userContext, String userDomainId, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime,String [] tokensExpr) throws Exception{
	...
	public  UserDomain addSecUser(MessagecenterUserContext userContext, String userDomainId, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime, String [] tokensExpr) throws Exception
	{	
	...
	protected void checkParamsForUpdatingSecUserProperties(MessagecenterUserContext userContext, String userDomainId,String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime,String [] tokensExpr) throws Exception {
	...
	public  UserDomain updateSecUserProperties(MessagecenterUserContext userContext, String userDomainId, String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime, String [] tokensExpr) throws Exception
	{	
	...
	protected SecUser createSecUser(MessagecenterUserContext userContext, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime) throws Exception{
	...
	protected void checkParamsForRemovingSecUserList(MessagecenterUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeSecUserList(MessagecenterUserContext userContext, String userDomainId, 
			String secUserIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSecUser(MessagecenterUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeSecUser(MessagecenterUserContext userContext, String userDomainId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSecUser(MessagecenterUserContext userContext, String userDomainId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	public  UserDomain copySecUserFrom(MessagecenterUserContext userContext, String userDomainId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUser(MessagecenterUserContext userContext, String userDomainId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserDomain updateSecUser(MessagecenterUserContext userContext, String userDomainId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
