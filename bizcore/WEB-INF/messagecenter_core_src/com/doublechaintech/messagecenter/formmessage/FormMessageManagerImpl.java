...
public class FormMessageManagerImpl extends CustomMessagecenterCheckerManager implements FormMessageManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormMessageManagerException{
 	...
 	protected FormMessage saveFormMessage(MessagecenterUserContext userContext, FormMessage formMessage, String [] tokensExpr) throws Exception{	
 	...
 	protected FormMessage saveFormMessageDetail(MessagecenterUserContext userContext, FormMessage formMessage) throws Exception{	
 	...
 	public FormMessage loadFormMessage(MessagecenterUserContext userContext, String formMessageId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormMessage searchFormMessage(MessagecenterUserContext userContext, String formMessageId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormMessage present(MessagecenterUserContext userContext, FormMessage formMessage, Map<String, Object> tokens) throws Exception {
 	...
 	public FormMessage loadFormMessageDetail(MessagecenterUserContext userContext, String formMessageId) throws Exception{	
 	...
 	public Object view(MessagecenterUserContext userContext, String formMessageId) throws Exception{	
 		FormMessage formMessage = loadFormMessage( userContext, formMessageId, viewTokens());
 		return present(userContext,formMessage, allTokens());
		
 	}
 	protected FormMessage saveFormMessage(MessagecenterUserContext userContext, FormMessage formMessage, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormMessageDAO().save(formMessage, tokens);
 	}
 	protected FormMessage loadFormMessage(MessagecenterUserContext userContext, String formMessageId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormMessage(formMessageId);
		userContext.getChecker().throwExceptionIfHasErrors( FormMessageManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, FormMessage formMessage, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, FormMessage formMessage, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormMessage(MessagecenterUserContext userContext,String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormMessage clone(MessagecenterUserContext userContext, String fromFormMessageId) throws Exception{
	...
	public FormMessage internalSaveFormMessage(MessagecenterUserContext userContext, FormMessage formMessage, Map<String,Object> options) throws Exception 
	{
	...
	public FormMessage updateFormMessageProperty(MessagecenterUserContext userContext,String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormMessage(userContext, formMessageId, formMessageVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(MessagecenterUserContext userContext, String formMessageId, String anotherFormId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(MessagecenterUserContext userContext, String formMessageId, int formMessageVersion) throws Exception {
	...
	public FormMessage forgetByAll(MessagecenterUserContext userContext, String formMessageId, int formMessageVersion) throws Exception {
		return forgetByAllInternal(userContext, formMessageId, formMessageVersion);		
	}
	protected FormMessage forgetByAllInternal(MessagecenterUserContext userContext,
			String formMessageId, int formMessageVersion) throws Exception{
