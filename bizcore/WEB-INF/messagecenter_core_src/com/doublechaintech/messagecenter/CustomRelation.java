...
public class CustomRelation extends BaseRelation{
	...
	protected void prepareRelation()
	{
		...
		//replaceGenericRelation("PrivateMessage"                        , BaseRelation.TRUST_CHAIN_ALL, "sender");
		//replaceGenericRelation("PrivateMessage"                        , BaseRelation.TRUST_CHAIN_ALL, "receiver");
		//replaceGenericRelation("PrivateMessage"                        , BaseRelation.TRUST_CHAIN_ALL, "platform");
	...
	protected void prepareRelationIndex()
	{
		...
		*/
		...
		//String [] privateMessageRelatedObjectNames = {"sender:Profile","receiver:Profile","platform:Platform"};
		//replaceRelationIndex("PrivateMessage",privateMessageRelatedObjectNames);
