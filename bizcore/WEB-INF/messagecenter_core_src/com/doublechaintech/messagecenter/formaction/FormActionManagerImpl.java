...
public class FormActionManagerImpl extends CustomMessagecenterCheckerManager implements FormActionManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormActionManagerException{
 	...
 	protected FormAction saveFormAction(MessagecenterUserContext userContext, FormAction formAction, String [] tokensExpr) throws Exception{	
 	...
 	protected FormAction saveFormActionDetail(MessagecenterUserContext userContext, FormAction formAction) throws Exception{	
 	...
 	public FormAction loadFormAction(MessagecenterUserContext userContext, String formActionId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormAction searchFormAction(MessagecenterUserContext userContext, String formActionId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormAction present(MessagecenterUserContext userContext, FormAction formAction, Map<String, Object> tokens) throws Exception {
 	...
 	public FormAction loadFormActionDetail(MessagecenterUserContext userContext, String formActionId) throws Exception{	
 		FormAction formAction = loadFormAction( userContext, formActionId, allTokens());
 		return present(userContext,formAction, allTokens());
		
 	}
 	
 	public Object view(MessagecenterUserContext userContext, String formActionId) throws Exception{	
 		FormAction formAction = loadFormAction( userContext, formActionId, viewTokens());
 		return present(userContext,formAction, allTokens());
		
 	}
 	protected FormAction saveFormAction(MessagecenterUserContext userContext, FormAction formAction, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormActionDAO().save(formAction, tokens);
 	}
 	protected FormAction loadFormAction(MessagecenterUserContext userContext, String formActionId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormAction(formActionId);
		userContext.getChecker().throwExceptionIfHasErrors( FormActionManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, FormAction formAction, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, FormAction formAction, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormAction(MessagecenterUserContext userContext,String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormAction clone(MessagecenterUserContext userContext, String fromFormActionId) throws Exception{
	...
	public FormAction internalSaveFormAction(MessagecenterUserContext userContext, FormAction formAction, Map<String,Object> options) throws Exception 
	{
	...
	public FormAction updateFormActionProperty(MessagecenterUserContext userContext,String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormAction(userContext, formActionId, formActionVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(MessagecenterUserContext userContext, String formActionId, String anotherFormId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(MessagecenterUserContext userContext, String formActionId, int formActionVersion) throws Exception {
	...
	public FormAction forgetByAll(MessagecenterUserContext userContext, String formActionId, int formActionVersion) throws Exception {
		return forgetByAllInternal(userContext, formActionId, formActionVersion);		
	}
	protected FormAction forgetByAllInternal(MessagecenterUserContext userContext,
			String formActionId, int formActionVersion) throws Exception{
