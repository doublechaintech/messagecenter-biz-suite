...
import com.doublechaintech.messagecenter.secuser.CandidateSecUser;
...
public class UserAppManagerImpl extends CustomMessagecenterCheckerManager implements UserAppManager {
	...
	protected void throwExceptionWithMessage(String value) throws UserAppManagerException{
 	...
 	protected UserApp saveUserApp(MessagecenterUserContext userContext, UserApp userApp, String [] tokensExpr) throws Exception{	
 	...
 	protected UserApp saveUserAppDetail(MessagecenterUserContext userContext, UserApp userApp) throws Exception{	
 	...
 	public UserApp loadUserApp(MessagecenterUserContext userContext, String userAppId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserApp searchUserApp(MessagecenterUserContext userContext, String userAppId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserApp present(MessagecenterUserContext userContext, UserApp userApp, Map<String, Object> tokens) throws Exception {
 	...
 	public UserApp loadUserAppDetail(MessagecenterUserContext userContext, String userAppId) throws Exception{	
 		UserApp userApp = loadUserApp( userContext, userAppId, allTokens());
 		return present(userContext,userApp, allTokens());
		
 	}
 	
 	public Object view(MessagecenterUserContext userContext, String userAppId) throws Exception{	
 		UserApp userApp = loadUserApp( userContext, userAppId, viewTokens());
 		return present(userContext,userApp, allTokens());
		
 	}
 	protected UserApp saveUserApp(MessagecenterUserContext userContext, UserApp userApp, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getUserAppDAO().save(userApp, tokens);
 	}
 	protected UserApp loadUserApp(MessagecenterUserContext userContext, String userAppId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfUserApp(userAppId);
		userContext.getChecker().throwExceptionIfHasErrors( UserAppManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, UserApp userApp, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, UserApp userApp, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserApp(MessagecenterUserContext userContext,String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserApp clone(MessagecenterUserContext userContext, String fromUserAppId) throws Exception{
	...
	public UserApp internalSaveUserApp(MessagecenterUserContext userContext, UserApp userApp, Map<String,Object> options) throws Exception 
	{
	...
	public UserApp updateUserAppProperty(MessagecenterUserContext userContext,String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingUserApp(userContext, userAppId, userAppVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(MessagecenterUserContext userContext, String userAppId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(MessagecenterUserContext userContext, String userAppId, String anotherLogin) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithLogin(MessagecenterUserContext userContext, String userAppId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(MessagecenterUserContext userContext, String userAppId, String anotherEmail) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithEmail(MessagecenterUserContext userContext, String userAppId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(MessagecenterUserContext userContext, String userAppId, String anotherMobile) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithMobile(MessagecenterUserContext userContext, String userAppId, String anotherMobile) throws Exception
 	{
	...
	public CandidateSecUser requestCandidateSecUser(MessagecenterUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected SecUser loadSecUser(MessagecenterUserContext userContext, String newSecUserId, Map<String,Object> options) throws Exception
 	{
		
 		return userContext.getDAOGroup().getSecUserDAO().load(newSecUserId, options);
 	}
 	
 	protected SecUser loadSecUserWithLogin(MessagecenterUserContext userContext, String newLogin, Map<String,Object> options) throws Exception
 	{
 	...
 	protected SecUser loadSecUserWithEmail(MessagecenterUserContext userContext, String newEmail, Map<String,Object> options) throws Exception
 	{
 	...
 	protected SecUser loadSecUserWithMobile(MessagecenterUserContext userContext, String newMobile, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(MessagecenterUserContext userContext, String userAppId, int userAppVersion) throws Exception {
	...
	public UserApp forgetByAll(MessagecenterUserContext userContext, String userAppId, int userAppVersion) throws Exception {
		return forgetByAllInternal(userContext, userAppId, userAppVersion);		
	}
	protected UserApp forgetByAllInternal(MessagecenterUserContext userContext,
			String userAppId, int userAppVersion) throws Exception{
	...
	protected void checkParamsForAddingListAccess(MessagecenterUserContext userContext, String userAppId, String name, String internalName, boolean readPermission, boolean createPermission, boolean deletePermission, boolean updatePermission, boolean executionPermission,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateListAccessProperties(MessagecenterUserContext userContext, String userAppId, String id,String name,String internalName,boolean readPermission,boolean createPermission,boolean deletePermission,boolean updatePermission,boolean executionPermission, String [] tokensExpr) throws Exception
	{	
	...
	protected ListAccess createListAccess(MessagecenterUserContext userContext, String name, String internalName, boolean readPermission, boolean createPermission, boolean deletePermission, boolean updatePermission, boolean executionPermission) throws Exception{
	...
	protected void checkParamsForRemovingListAccessList(MessagecenterUserContext userContext, String userAppId, 
	...
	public  UserApp removeListAccessList(MessagecenterUserContext userContext, String userAppId, 
			String listAccessIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingListAccess(MessagecenterUserContext userContext, String userAppId, 
	...
	public  UserApp removeListAccess(MessagecenterUserContext userContext, String userAppId, 
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingListAccess(MessagecenterUserContext userContext, String userAppId, 
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	public  UserApp copyListAccessFrom(MessagecenterUserContext userContext, String userAppId, 
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingListAccess(MessagecenterUserContext userContext, String userAppId, String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateListAccess(MessagecenterUserContext userContext, String userAppId, String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingObjectAccess(MessagecenterUserContext userContext, String userAppId, String name, String objectType, String list1, String list2, String list3, String list4, String list5, String list6, String list7, String list8, String list9,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateObjectAccessProperties(MessagecenterUserContext userContext, String userAppId, String id,String name,String objectType,String list1,String list2,String list3,String list4,String list5,String list6,String list7,String list8,String list9, String [] tokensExpr) throws Exception
	{	
	...
	protected ObjectAccess createObjectAccess(MessagecenterUserContext userContext, String name, String objectType, String list1, String list2, String list3, String list4, String list5, String list6, String list7, String list8, String list9) throws Exception{
	...
	protected void checkParamsForRemovingObjectAccessList(MessagecenterUserContext userContext, String userAppId, 
	...
	public  UserApp removeObjectAccessList(MessagecenterUserContext userContext, String userAppId, 
			String objectAccessIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingObjectAccess(MessagecenterUserContext userContext, String userAppId, 
	...
	public  UserApp removeObjectAccess(MessagecenterUserContext userContext, String userAppId, 
		String objectAccessId, int objectAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingObjectAccess(MessagecenterUserContext userContext, String userAppId, 
		String objectAccessId, int objectAccessVersion,String [] tokensExpr) throws Exception{
	...
	public  UserApp copyObjectAccessFrom(MessagecenterUserContext userContext, String userAppId, 
		String objectAccessId, int objectAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingObjectAccess(MessagecenterUserContext userContext, String userAppId, String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateObjectAccess(MessagecenterUserContext userContext, String userAppId, String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
