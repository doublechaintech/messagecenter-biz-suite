...
public class MessagecenterExceptionJsonSerializer extends  JsonSerializer<MessagecenterException> {
	...
	@Override
	public void serialize(MessagecenterException exception, JsonGenerator jgen,
	...
	protected void writeExceptionMessage(String message, MessagecenterException exception,
	...
	protected void writeStartObject(MessagecenterException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		jgen.writeStartObject();
		writeClassField(CLASS,exception,jgen,provider);
	}
	
	private static final String MESSAGE_LIST = "messageList";
	protected void writeEndObject(MessagecenterException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		
		writeMessageList(MESSAGE_LIST,exception,jgen,provider);
		jgen.writeEndObject();
	}
	protected void writeClassField(String fieldName,MessagecenterException exception,
	...
	protected void writeMessageList(String fieldName,MessagecenterException exception,
			JsonGenerator jgen, SerializerProvider provider)
			throws IOException, JsonProcessingException {
		if(exception == null){
			return; //do nothing when base entity is null
