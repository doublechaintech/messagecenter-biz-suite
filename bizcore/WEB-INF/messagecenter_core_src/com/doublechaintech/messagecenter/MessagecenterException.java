...
@JsonSerialize(using = MessagecenterExceptionJsonSerializer.class)
public class MessagecenterException extends Exception implements MessageContainer {
    ...
    public MessagecenterException(Message message) {
    	super();
        this.addErrorMessage(message);
    }
	public MessagecenterException(List<Message> messageList) {
        super();
