...
public class GenericFormManagerImpl extends CustomMessagecenterCheckerManager implements GenericFormManager {
	...
	protected void throwExceptionWithMessage(String value) throws GenericFormManagerException{
 	...
 	protected GenericForm saveGenericForm(MessagecenterUserContext userContext, GenericForm genericForm, String [] tokensExpr) throws Exception{	
 	...
 	protected GenericForm saveGenericFormDetail(MessagecenterUserContext userContext, GenericForm genericForm) throws Exception{	
 	...
 	public GenericForm loadGenericForm(MessagecenterUserContext userContext, String genericFormId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public GenericForm searchGenericForm(MessagecenterUserContext userContext, String genericFormId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected GenericForm present(MessagecenterUserContext userContext, GenericForm genericForm, Map<String, Object> tokens) throws Exception {
 	...
 	public GenericForm loadGenericFormDetail(MessagecenterUserContext userContext, String genericFormId) throws Exception{	
 	...
 	public Object view(MessagecenterUserContext userContext, String genericFormId) throws Exception{	
 		GenericForm genericForm = loadGenericForm( userContext, genericFormId, viewTokens());
 		return present(userContext,genericForm, allTokens());
		
 	}
 	protected GenericForm saveGenericForm(MessagecenterUserContext userContext, GenericForm genericForm, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getGenericFormDAO().save(genericForm, tokens);
 	}
 	protected GenericForm loadGenericForm(MessagecenterUserContext userContext, String genericFormId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfGenericForm(genericFormId);
		userContext.getChecker().throwExceptionIfHasErrors( GenericFormManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, GenericForm genericForm, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, GenericForm genericForm, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingGenericForm(MessagecenterUserContext userContext,String genericFormId, int genericFormVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public GenericForm clone(MessagecenterUserContext userContext, String fromGenericFormId) throws Exception{
	...
	public GenericForm internalSaveGenericForm(MessagecenterUserContext userContext, GenericForm genericForm, Map<String,Object> options) throws Exception 
	{
	...
	public GenericForm updateGenericFormProperty(MessagecenterUserContext userContext,String genericFormId, int genericFormVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingGenericForm(userContext, genericFormId, genericFormVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(MessagecenterUserContext userContext, String genericFormId, int genericFormVersion) throws Exception {
	...
	public GenericForm forgetByAll(MessagecenterUserContext userContext, String genericFormId, int genericFormVersion) throws Exception {
		return forgetByAllInternal(userContext, genericFormId, genericFormVersion);		
	}
	protected GenericForm forgetByAllInternal(MessagecenterUserContext userContext,
			String genericFormId, int genericFormVersion) throws Exception{
	...
	protected void checkParamsForAddingFormMessage(MessagecenterUserContext userContext, String genericFormId, String title, String level,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormMessageProperties(MessagecenterUserContext userContext, String genericFormId,String id,String title,String level,String [] tokensExpr) throws Exception {
	...
	public  GenericForm updateFormMessageProperties(MessagecenterUserContext userContext, String genericFormId, String id,String title,String level, String [] tokensExpr) throws Exception
	{	
	...
	protected FormMessage createFormMessage(MessagecenterUserContext userContext, String title, String level) throws Exception{
	...
	protected void checkParamsForRemovingFormMessageList(MessagecenterUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormMessageList(MessagecenterUserContext userContext, String genericFormId, 
			String formMessageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormMessage(MessagecenterUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormMessage(MessagecenterUserContext userContext, String genericFormId, 
		String formMessageId, int formMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormMessage(MessagecenterUserContext userContext, String genericFormId, 
		String formMessageId, int formMessageVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormMessageFrom(MessagecenterUserContext userContext, String genericFormId, 
		String formMessageId, int formMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormMessage(MessagecenterUserContext userContext, String genericFormId, String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormMessage(MessagecenterUserContext userContext, String genericFormId, String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingFormFieldMessage(MessagecenterUserContext userContext, String genericFormId, String title, String parameterName, String level,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormFieldMessageProperties(MessagecenterUserContext userContext, String genericFormId,String id,String title,String parameterName,String level,String [] tokensExpr) throws Exception {
	...
	public  GenericForm updateFormFieldMessageProperties(MessagecenterUserContext userContext, String genericFormId, String id,String title,String parameterName,String level, String [] tokensExpr) throws Exception
	{	
	...
	protected FormFieldMessage createFormFieldMessage(MessagecenterUserContext userContext, String title, String parameterName, String level) throws Exception{
	...
	protected void checkParamsForRemovingFormFieldMessageList(MessagecenterUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormFieldMessageList(MessagecenterUserContext userContext, String genericFormId, 
			String formFieldMessageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormFieldMessage(MessagecenterUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormFieldMessage(MessagecenterUserContext userContext, String genericFormId, 
		String formFieldMessageId, int formFieldMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormFieldMessage(MessagecenterUserContext userContext, String genericFormId, 
		String formFieldMessageId, int formFieldMessageVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormFieldMessageFrom(MessagecenterUserContext userContext, String genericFormId, 
		String formFieldMessageId, int formFieldMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormFieldMessage(MessagecenterUserContext userContext, String genericFormId, String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormFieldMessage(MessagecenterUserContext userContext, String genericFormId, String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	public  GenericForm updateFormFieldProperties(MessagecenterUserContext userContext, String genericFormId, String id,String label,String localeKey,String parameterName,String type,String placeholder,String defaultValue,String description,String fieldGroup,String minimumValue,String maximumValue,boolean required,boolean disabled,boolean customRendering,String candidateValues,String suggestValues, String [] tokensExpr) throws Exception
	{	
	...
	protected FormField createFormField(MessagecenterUserContext userContext, String label, String localeKey, String parameterName, String type, String placeholder, String defaultValue, String description, String fieldGroup, String minimumValue, String maximumValue, boolean required, boolean disabled, boolean customRendering, String candidateValues, String suggestValues) throws Exception{
	...
	protected void checkParamsForRemovingFormFieldList(MessagecenterUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormFieldList(MessagecenterUserContext userContext, String genericFormId, 
			String formFieldIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormField(MessagecenterUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormField(MessagecenterUserContext userContext, String genericFormId, 
		String formFieldId, int formFieldVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormField(MessagecenterUserContext userContext, String genericFormId, 
		String formFieldId, int formFieldVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormFieldFrom(MessagecenterUserContext userContext, String genericFormId, 
		String formFieldId, int formFieldVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormField(MessagecenterUserContext userContext, String genericFormId, String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormField(MessagecenterUserContext userContext, String genericFormId, String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingFormAction(MessagecenterUserContext userContext, String genericFormId, String label, String localeKey, String actionKey, String level, String url,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormActionProperties(MessagecenterUserContext userContext, String genericFormId,String id,String label,String localeKey,String actionKey,String level,String url,String [] tokensExpr) throws Exception {
	...
	public  GenericForm updateFormActionProperties(MessagecenterUserContext userContext, String genericFormId, String id,String label,String localeKey,String actionKey,String level,String url, String [] tokensExpr) throws Exception
	{	
	...
	protected FormAction createFormAction(MessagecenterUserContext userContext, String label, String localeKey, String actionKey, String level, String url) throws Exception{
	...
	protected void checkParamsForRemovingFormActionList(MessagecenterUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormActionList(MessagecenterUserContext userContext, String genericFormId, 
			String formActionIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormAction(MessagecenterUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormAction(MessagecenterUserContext userContext, String genericFormId, 
		String formActionId, int formActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormAction(MessagecenterUserContext userContext, String genericFormId, 
		String formActionId, int formActionVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormActionFrom(MessagecenterUserContext userContext, String genericFormId, 
		String formActionId, int formActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormAction(MessagecenterUserContext userContext, String genericFormId, String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormAction(MessagecenterUserContext userContext, String genericFormId, String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
