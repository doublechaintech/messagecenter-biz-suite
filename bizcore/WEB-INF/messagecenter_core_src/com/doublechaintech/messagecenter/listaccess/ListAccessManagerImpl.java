...
public class ListAccessManagerImpl extends CustomMessagecenterCheckerManager implements ListAccessManager {
	...
	protected void throwExceptionWithMessage(String value) throws ListAccessManagerException{
 	...
 	protected ListAccess saveListAccess(MessagecenterUserContext userContext, ListAccess listAccess, String [] tokensExpr) throws Exception{	
 	...
 	protected ListAccess saveListAccessDetail(MessagecenterUserContext userContext, ListAccess listAccess) throws Exception{	
 	...
 	public ListAccess loadListAccess(MessagecenterUserContext userContext, String listAccessId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ListAccess searchListAccess(MessagecenterUserContext userContext, String listAccessId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ListAccess present(MessagecenterUserContext userContext, ListAccess listAccess, Map<String, Object> tokens) throws Exception {
 	...
 	public ListAccess loadListAccessDetail(MessagecenterUserContext userContext, String listAccessId) throws Exception{	
 		ListAccess listAccess = loadListAccess( userContext, listAccessId, allTokens());
 		return present(userContext,listAccess, allTokens());
		
 	}
 	
 	public Object view(MessagecenterUserContext userContext, String listAccessId) throws Exception{	
 		ListAccess listAccess = loadListAccess( userContext, listAccessId, viewTokens());
 		return present(userContext,listAccess, allTokens());
		
 	}
 	protected ListAccess saveListAccess(MessagecenterUserContext userContext, ListAccess listAccess, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getListAccessDAO().save(listAccess, tokens);
 	}
 	protected ListAccess loadListAccess(MessagecenterUserContext userContext, String listAccessId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfListAccess(listAccessId);
		userContext.getChecker().throwExceptionIfHasErrors( ListAccessManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, ListAccess listAccess, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, ListAccess listAccess, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingListAccess(MessagecenterUserContext userContext,String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ListAccess clone(MessagecenterUserContext userContext, String fromListAccessId) throws Exception{
	...
	public ListAccess internalSaveListAccess(MessagecenterUserContext userContext, ListAccess listAccess, Map<String,Object> options) throws Exception 
	{
	...
	public ListAccess updateListAccessProperty(MessagecenterUserContext userContext,String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingListAccess(userContext, listAccessId, listAccessVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherApp(MessagecenterUserContext userContext, String listAccessId, String anotherAppId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(MessagecenterUserContext userContext, String listAccessId, int listAccessVersion) throws Exception {
	...
	public ListAccess forgetByAll(MessagecenterUserContext userContext, String listAccessId, int listAccessVersion) throws Exception {
		return forgetByAllInternal(userContext, listAccessId, listAccessVersion);		
	}
	protected ListAccess forgetByAllInternal(MessagecenterUserContext userContext,
			String listAccessId, int listAccessVersion) throws Exception{
