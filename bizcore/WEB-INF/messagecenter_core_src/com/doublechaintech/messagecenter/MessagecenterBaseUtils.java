...
public class MessagecenterBaseUtils {
	...
	public static String getCacheAccessKey(MessagecenterUserContext ctx) {
	...
	protected static BaseEntity loadCanCacheInLocal(MessagecenterUserContext userContext, String type, String id) throws Exception {
	...
	public static <T extends BaseEntity> List<T> collectReferencedObjectWithType(MessagecenterUserContext userContext,
	...
	private static <T extends BaseEntity> void collectReferedObjectIdSet(MessagecenterUserContext userContext,
	...
	public static int getAppBuildVersion(MessagecenterUserContext ctx) {
		return getBuildVersion(getRequestAppVersion(ctx));
	}
	protected static boolean startFromVersion(MessagecenterUserContext ctx, int version) {
     ...
     * "x-app-version" : "9"
	 */
	public static String getRequestAppVersion(MessagecenterUserContext userContext) {
		return userContext.getRequestHeader("x-app-version");
	}
	public static String getRequestAppDevice(MessagecenterUserContext userContext) {
		return userContext.getRequestHeader("x-app-device");
	}
	public static String getRequestAppType(MessagecenterUserContext userContext) {
