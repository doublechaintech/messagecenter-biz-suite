...
import com.doublechaintech.messagecenter.secuser.SecUserCustomManagerImpl;
...
public class MessagecenterUserContextImpl extends UserContextImpl implements MessagecenterUserContext{
	...
	static final String RESOURCE_PATH="com.doublechaintech.messagecenter.MessagecenterResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechaintech.messagecenter.MessagecenterCustomResources";
    ...
    /*
    public static SecUser getSecUser(MessagecenterUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(MessagecenterUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(MessagecenterUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(MessagecenterUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
	...
	private MessagecenterChecker checker;
