...
import com.doublechaintech.messagecenter.genericform.CandidateGenericForm;
...
public class FormFieldMessageManagerImpl extends CustomMessagecenterCheckerManager implements FormFieldMessageManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormFieldMessageManagerException{
 	...
 	protected FormFieldMessage saveFormFieldMessage(MessagecenterUserContext userContext, FormFieldMessage formFieldMessage, String [] tokensExpr) throws Exception{	
 	...
 	protected FormFieldMessage saveFormFieldMessageDetail(MessagecenterUserContext userContext, FormFieldMessage formFieldMessage) throws Exception{	
 	...
 	public FormFieldMessage loadFormFieldMessage(MessagecenterUserContext userContext, String formFieldMessageId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormFieldMessage searchFormFieldMessage(MessagecenterUserContext userContext, String formFieldMessageId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormFieldMessage present(MessagecenterUserContext userContext, FormFieldMessage formFieldMessage, Map<String, Object> tokens) throws Exception {
 	...
 	public FormFieldMessage loadFormFieldMessageDetail(MessagecenterUserContext userContext, String formFieldMessageId) throws Exception{	
 	...
 	public Object view(MessagecenterUserContext userContext, String formFieldMessageId) throws Exception{	
 		FormFieldMessage formFieldMessage = loadFormFieldMessage( userContext, formFieldMessageId, viewTokens());
 		return present(userContext,formFieldMessage, allTokens());
		
 	}
 	protected FormFieldMessage saveFormFieldMessage(MessagecenterUserContext userContext, FormFieldMessage formFieldMessage, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormFieldMessageDAO().save(formFieldMessage, tokens);
 	}
 	protected FormFieldMessage loadFormFieldMessage(MessagecenterUserContext userContext, String formFieldMessageId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormFieldMessage(formFieldMessageId);
		userContext.getChecker().throwExceptionIfHasErrors( FormFieldMessageManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, FormFieldMessage formFieldMessage, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(MessagecenterUserContext userContext, FormFieldMessage formFieldMessage, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormFieldMessage(MessagecenterUserContext userContext,String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormFieldMessage clone(MessagecenterUserContext userContext, String fromFormFieldMessageId) throws Exception{
	...
	public FormFieldMessage internalSaveFormFieldMessage(MessagecenterUserContext userContext, FormFieldMessage formFieldMessage, Map<String,Object> options) throws Exception 
	{
	...
	public FormFieldMessage updateFormFieldMessageProperty(MessagecenterUserContext userContext,String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormFieldMessage(userContext, formFieldMessageId, formFieldMessageVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(MessagecenterUserContext userContext, String formFieldMessageId, String anotherFormId) throws Exception
 	{
	...
	public CandidateGenericForm requestCandidateForm(MessagecenterUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected GenericForm loadGenericForm(MessagecenterUserContext userContext, String newFormId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(MessagecenterUserContext userContext, String formFieldMessageId, int formFieldMessageVersion) throws Exception {
	...
	public FormFieldMessage forgetByAll(MessagecenterUserContext userContext, String formFieldMessageId, int formFieldMessageVersion) throws Exception {
		return forgetByAllInternal(userContext, formFieldMessageId, formFieldMessageVersion);		
	}
	protected FormFieldMessage forgetByAllInternal(MessagecenterUserContext userContext,
			String formFieldMessageId, int formFieldMessageVersion) throws Exception{
