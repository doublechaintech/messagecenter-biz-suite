...
public class BaseRelation{
	...
	protected void prepareRelationIndex()
	{
		...
		addRelationIndex("PrivateMessage",privateMessageRelatedObjectNames);
	...
	protected void prepareRelation()
	{
		...
		addGenericRelation("PrivateMessage"                        ,TRUST_CHAIN_READ,"sender");
		addGenericRelation("PrivateMessage"                        ,TRUST_CHAIN_READ,"receiver");
		addGenericRelation("PrivateMessage"                        ,TRUST_CHAIN_READ,"platform");
