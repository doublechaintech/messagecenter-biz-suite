...
public class MessagecenterChecker extends BaseChecker{
	...
	public MessagecenterChecker checkIdOfPlatform(String id)
	{
	...
	public MessagecenterChecker checkNameOfPlatform(String name)
	{
	...
	public MessagecenterChecker checkIntroductionOfPlatform(String introduction)
	{
	...
	public MessagecenterChecker checkCurrentVersionOfPlatform(String currentVersion)
	{
	...
	public MessagecenterChecker checkVersionOfPlatform(int version)
	{
	...
	public MessagecenterChecker checkIdOfProfile(String id)
	{
	...
	public MessagecenterChecker checkNameOfProfile(String name)
	{
	...
	public MessagecenterChecker checkPlatformIdOfProfile(String platformId)
	{
	...
	public MessagecenterChecker checkVersionOfProfile(int version)
	{
	...
	public MessagecenterChecker checkIdOfPrivateMessage(String id)
	{
		
	 	checkStringLengthRange(id,5, 64,ID_OF_PRIVATE_MESSAGE ); 		
		
		return this;
	}	 			

	public static final String  TITLE_OF_PRIVATE_MESSAGE ="private_message.title";
	public MessagecenterChecker checkTitleOfPrivateMessage(String title)
	{
		
	 	checkStringLengthRange(title,4, 56,TITLE_OF_PRIVATE_MESSAGE ); 		
		
		return this;
	}	 			

	public static final String  CONTENT_OF_PRIVATE_MESSAGE ="private_message.content";
	public MessagecenterChecker checkContentOfPrivateMessage(String content)
	{
		
	 	checkLongtext(content,0, 1048576,CONTENT_OF_PRIVATE_MESSAGE ); 		
		
		return this;
	}	 			

	public static final String  SENDER_OF_PRIVATE_MESSAGE ="private_message.sender";
	public MessagecenterChecker checkSenderIdOfPrivateMessage(String senderId)
	{
		
	 	checkIdOfPrivateMessage(senderId ); 		
		
		return this;
	}	 			

	public static final String  RECEIVER_OF_PRIVATE_MESSAGE ="private_message.receiver";
	public MessagecenterChecker checkReceiverIdOfPrivateMessage(String receiverId)
	{
		
	 	checkIdOfPrivateMessage(receiverId ); 		
		
		return this;
	}	 			

	public static final String  STATUS_OF_PRIVATE_MESSAGE ="private_message.status";
	public MessagecenterChecker checkStatusOfPrivateMessage(String status)
	{
		
	 	checkStringLengthRange(status,2, 24,STATUS_OF_PRIVATE_MESSAGE ); 		
		
		return this;
	}	 			

	public static final String  PLATFORM_OF_PRIVATE_MESSAGE ="private_message.platform";
	public MessagecenterChecker checkPlatformIdOfPrivateMessage(String platformId)
	{
		
	 	checkIdOfPrivateMessage(platformId ); 		
		
		return this;
	}	 			

	public static final String  VERSION_OF_PRIVATE_MESSAGE ="private_message.version";
	public MessagecenterChecker checkVersionOfPrivateMessage(int version)
	{
		
	 	checkIntegerRange(version,0, Integer.MAX_VALUE,VERSION_OF_PRIVATE_MESSAGE ); 		
		
		return this;
	}	 			

	public static final String  ID_OF_USER_DOMAIN ="user_domain.id";
	public MessagecenterChecker checkIdOfUserDomain(String id)
	{
	...
	public MessagecenterChecker checkNameOfUserDomain(String name)
	{
	...
	public MessagecenterChecker checkVersionOfUserDomain(int version)
	{
	...
	public MessagecenterChecker checkIdOfUserWhiteList(String id)
	{
	...
	public MessagecenterChecker checkUserIdentityOfUserWhiteList(String userIdentity)
	{
	...
	public MessagecenterChecker checkUserSpecialFunctionsOfUserWhiteList(String userSpecialFunctions)
	{
	...
	public MessagecenterChecker checkDomainIdOfUserWhiteList(String domainId)
	{
	...
	public MessagecenterChecker checkVersionOfUserWhiteList(int version)
	{
	...
	public MessagecenterChecker checkIdOfSecUser(String id)
	{
	...
	public MessagecenterChecker checkLoginOfSecUser(String login)
	{
	...
	public MessagecenterChecker checkMobileOfSecUser(String mobile)
	{
	...
	public MessagecenterChecker checkEmailOfSecUser(String email)
	{
	...
	public MessagecenterChecker checkPwdOfSecUser(String pwd)
	{
	...
	public MessagecenterChecker checkVerificationCodeExpireOfSecUser(DateTime verificationCodeExpire)
	{
	...
	public MessagecenterChecker checkLastLoginTimeOfSecUser(DateTime lastLoginTime)
	{
	...
	public MessagecenterChecker checkDomainIdOfSecUser(String domainId)
	{
	...
	public MessagecenterChecker checkVersionOfSecUser(int version)
	{
	...
	public MessagecenterChecker checkIdOfSecUserBlocking(String id)
	{
	...
	public MessagecenterChecker checkWhoOfSecUserBlocking(String who)
	{
	...
	public MessagecenterChecker checkCommentsOfSecUserBlocking(String comments)
	{
	...
	public MessagecenterChecker checkVersionOfSecUserBlocking(int version)
	{
	...
	public MessagecenterChecker checkIdOfUserApp(String id)
	{
	...
	public MessagecenterChecker checkTitleOfUserApp(String title)
	{
	...
	public MessagecenterChecker checkSecUserIdOfUserApp(String secUserId)
	{
	...
	public MessagecenterChecker checkAppIconOfUserApp(String appIcon)
	{
	...
	public MessagecenterChecker checkFullAccessOfUserApp(boolean fullAccess)
	{
	...
	public MessagecenterChecker checkPermissionOfUserApp(String permission)
	{
	...
	public MessagecenterChecker checkObjectIdOfUserApp(String objectId)
	{
	...
	public MessagecenterChecker checkLocationOfUserApp(String location)
	{
	...
	public MessagecenterChecker checkVersionOfUserApp(int version)
	{
	...
	public MessagecenterChecker checkIdOfListAccess(String id)
	{
	...
	public MessagecenterChecker checkReadPermissionOfListAccess(boolean readPermission)
	{
	...
	public MessagecenterChecker checkCreatePermissionOfListAccess(boolean createPermission)
	{
	...
	public MessagecenterChecker checkDeletePermissionOfListAccess(boolean deletePermission)
	{
	...
	public MessagecenterChecker checkUpdatePermissionOfListAccess(boolean updatePermission)
	{
	...
	public MessagecenterChecker checkExecutionPermissionOfListAccess(boolean executionPermission)
	{
	...
	public MessagecenterChecker checkAppIdOfListAccess(String appId)
	{
	...
	public MessagecenterChecker checkVersionOfListAccess(int version)
	{
	...
	public MessagecenterChecker checkIdOfObjectAccess(String id)
	{
	...
	public MessagecenterChecker checkNameOfObjectAccess(String name)
	{
	...
	public MessagecenterChecker checkObjectTypeOfObjectAccess(String objectType)
	{
	...
	public MessagecenterChecker checkList1OfObjectAccess(String list1)
	{
	...
	public MessagecenterChecker checkList2OfObjectAccess(String list2)
	{
	...
	public MessagecenterChecker checkList3OfObjectAccess(String list3)
	{
	...
	public MessagecenterChecker checkList4OfObjectAccess(String list4)
	{
	...
	public MessagecenterChecker checkList5OfObjectAccess(String list5)
	{
	...
	public MessagecenterChecker checkList6OfObjectAccess(String list6)
	{
	...
	public MessagecenterChecker checkList7OfObjectAccess(String list7)
	{
	...
	public MessagecenterChecker checkList8OfObjectAccess(String list8)
	{
	...
	public MessagecenterChecker checkList9OfObjectAccess(String list9)
	{
	...
	public MessagecenterChecker checkAppIdOfObjectAccess(String appId)
	{
	...
	public MessagecenterChecker checkVersionOfObjectAccess(int version)
	{
	...
	public MessagecenterChecker checkIdOfLoginHistory(String id)
	{
	...
	public MessagecenterChecker checkFromIpOfLoginHistory(String fromIp)
	{
	...
	public MessagecenterChecker checkDescriptionOfLoginHistory(String description)
	{
	...
	public MessagecenterChecker checkSecUserIdOfLoginHistory(String secUserId)
	{
	...
	public MessagecenterChecker checkVersionOfLoginHistory(int version)
	{
	...
	public MessagecenterChecker checkIdOfGenericForm(String id)
	{
	...
	public MessagecenterChecker checkTitleOfGenericForm(String title)
	{
	...
	public MessagecenterChecker checkDescriptionOfGenericForm(String description)
	{
	...
	public MessagecenterChecker checkVersionOfGenericForm(int version)
	{
	...
	public MessagecenterChecker checkIdOfFormMessage(String id)
	{
	...
	public MessagecenterChecker checkTitleOfFormMessage(String title)
	{
	...
	public MessagecenterChecker checkFormIdOfFormMessage(String formId)
	{
	...
	public MessagecenterChecker checkLevelOfFormMessage(String level)
	{
	...
	public MessagecenterChecker checkVersionOfFormMessage(int version)
	{
	...
	public MessagecenterChecker checkIdOfFormFieldMessage(String id)
	{
	...
	public MessagecenterChecker checkTitleOfFormFieldMessage(String title)
	{
	...
	public MessagecenterChecker checkParameterNameOfFormFieldMessage(String parameterName)
	{
	...
	public MessagecenterChecker checkFormIdOfFormFieldMessage(String formId)
	{
	...
	public MessagecenterChecker checkLevelOfFormFieldMessage(String level)
	{
	...
	public MessagecenterChecker checkVersionOfFormFieldMessage(int version)
	{
	...
	public MessagecenterChecker checkIdOfFormField(String id)
	{
	...
	public MessagecenterChecker checkLabelOfFormField(String label)
	{
	...
	public MessagecenterChecker checkLocaleKeyOfFormField(String localeKey)
	{
	...
	public MessagecenterChecker checkParameterNameOfFormField(String parameterName)
	{
	...
	public MessagecenterChecker checkTypeOfFormField(String type)
	{
	...
	public MessagecenterChecker checkFormIdOfFormField(String formId)
	{
	...
	public MessagecenterChecker checkPlaceholderOfFormField(String placeholder)
	{
	...
	public MessagecenterChecker checkDefaultValueOfFormField(String defaultValue)
	{
	...
	public MessagecenterChecker checkDescriptionOfFormField(String description)
	{
	...
	public MessagecenterChecker checkFieldGroupOfFormField(String fieldGroup)
	{
	...
	public MessagecenterChecker checkMinimumValueOfFormField(String minimumValue)
	{
	...
	public MessagecenterChecker checkMaximumValueOfFormField(String maximumValue)
	{
	...
	public MessagecenterChecker checkRequiredOfFormField(boolean required)
	{
	...
	public MessagecenterChecker checkDisabledOfFormField(boolean disabled)
	{
	...
	public MessagecenterChecker checkCustomRenderingOfFormField(boolean customRendering)
	{
	...
	public MessagecenterChecker checkCandidateValuesOfFormField(String candidateValues)
	{
	...
	public MessagecenterChecker checkSuggestValuesOfFormField(String suggestValues)
	{
	...
	public MessagecenterChecker checkVersionOfFormField(int version)
	{
	...
	public MessagecenterChecker checkIdOfFormAction(String id)
	{
	...
	public MessagecenterChecker checkLabelOfFormAction(String label)
	{
	...
	public MessagecenterChecker checkLocaleKeyOfFormAction(String localeKey)
	{
	...
	public MessagecenterChecker checkActionKeyOfFormAction(String actionKey)
	{
	...
	public MessagecenterChecker checkLevelOfFormAction(String level)
	{
	...
	public MessagecenterChecker checkUrlOfFormAction(String url)
	{
	...
	public MessagecenterChecker checkFormIdOfFormAction(String formId)
	{
	...
	public MessagecenterChecker checkVersionOfFormAction(int version)
	{
