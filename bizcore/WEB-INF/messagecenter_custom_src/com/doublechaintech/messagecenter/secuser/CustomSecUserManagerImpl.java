...
import com.doublechaintech.messagecenter.MessagecenterUserContextImpl;
import com.doublechaintech.messagecenter.LoginForm;
import com.doublechaintech.messagecenter.BaseEntity;
import com.doublechaintech.messagecenter.CommonError;
import com.doublechaintech.messagecenter.DAOGroup;
import com.doublechaintech.messagecenter.ManagerGroup;

import com.doublechaintech.messagecenter.UserContextImpl;
...
import com.doublechaintech.messagecenter.userapp.*;
import com.doublechaintech.messagecenter.listaccess.*;
import com.doublechaintech.messagecenter.objectaccess.*;
import com.doublechaintech.messagecenter.MessagecenterChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(MessagecenterUserContext userContext){
    ...
    public Object resetPassword(MessagecenterUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(MessagecenterUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(MessagecenterUserContext userContext,
    ...
    public SecUser manage(MessagecenterUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(MessagecenterUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(MessagecenterUserContext userContext) {
    ...
    protected Object gotoApp(MessagecenterUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(MessagecenterUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(MessagecenterUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(MessagecenterUserContext userContex, int length){
    ...
    protected String getBeanName(MessagecenterUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(MessagecenterUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(MessagecenterUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(MessagecenterUserContext userContext, UserApp app){
    ...
    public Object home(MessagecenterUserContext userContext) {
    ...
    public Object loginWithEmail(MessagecenterUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(MessagecenterUserContext userContext, String email,
            String password) {
    ...
    public Object loginWithLogin(MessagecenterUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(MessagecenterUserContext userContext, String email,
            String password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(MessagecenterUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(MessagecenterUserContext userContext, String type, String userId,
            String password) {
     ...
     */
    protected Object loginTheSecUserInternal(MessagecenterUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(MessagecenterUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(MessagecenterUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        MessagecenterUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected MessagecenterChecker checker;
    public MessagecenterChecker getChecker(){
        return checker;
    }
    
    public void setChecker(MessagecenterChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((MessagecenterChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected MessagecenterUserContextImpl createNewConext(String path) {

        return new MessagecenterUserContextImpl();
    ...
    public Object checkOtherLogin(MessagecenterUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(MessagecenterUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(MessagecenterUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(MessagecenterUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(MessagecenterUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(MessagecenterUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(MessagecenterUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
